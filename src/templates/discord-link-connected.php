...
<?php if (!isset($membership)) { ?>
    <p>
        ...
        <a href="/discord/link">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="228.75"
                 height="28"
                 role="img" aria-label="Join the Seattle Makers discord server"><title>Join the Seattle Makers discord
                    server!</title>
                ...
                <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif"
                   text-rendering="geometricPrecision" font-size="100">
                    ...
                    <text transform="scale(.1)" x="496.25" y="175" textLength="412.5" fill="#fff" font-weight="bold">
                        Seattle
                        Makers
                    </text>
                    <text transform="scale(.1)" x="1555" y="175" textLength="1225" fill="#fff" font-weight="bold">Join
                        us on
                        Discord
                    </text>
                </g>
...
<?php } else { ?>
    <p>You're already in the Seattle Makers discord server; <a
                href="https://discord.com/channels/<?php echo $server_id ?>">go to Discord</a> to start chatting!</p>
<?php } ?>
...
<?php if (count($roles) > 0) { ?>
    ...
    <p>To claim the roles in the Discord App, click on the Seattle Makers server name (in the top left), and choose
        "Linked Roles" from the menu.</p>
<?php } ?>
